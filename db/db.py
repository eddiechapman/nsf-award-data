...
class RelatedPrograms(UniqueMixin, Base):
    ...
    primary = saorm.relationship(
        'Program',
        foreign_keys='RelatedPrograms.pgm1_id',
        uselist=False,
        single_parent=True,
    ...
    secondary = saorm.relationship(
        'Program',
        foreign_keys='RelatedPrograms.pgm2_id',
        uselist=False,
        single_parent=True,
    )
...
class Award(UniqueMixin, Base):
    ...
    publications = saorm.relationship(
        'Publication',
        backref=saorm.backref('award', uselist=False),
    )
...
class Publication(BasicMixin, Base):
    ...
    award_id = Column(
        Integer,
        ForeignKey('award.id', ondelete='SET NULL'),
    )
